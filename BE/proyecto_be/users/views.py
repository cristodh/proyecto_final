...
# ============================================================
# VISTAS CRUD - LISTAR Y CREAR MODELOS
# ============================================================
...
class CreateAdminUser(APIView):
    permission_classes = [IsAdminUser]  # Solo administradores pueden crear otros administradores
    def post(self, request):
        username = request.data.get('username')
        password = request.data.get('password')
...
class DeleteRoleView(DestroyAPIView):
    # permission_classes = [IsAdminUser]  # Solo administradores pueden eliminar roles
