...
export default function ManagerSidebar({ open, onClose, user }) { 
  ...
  const isActiveRoute = (path) => {
    return location.pathname.includes(`manager_profile${path}`);
  };

  // Función para navegar a una ruta específica
  const handleNavigation = (path) => {
    navigate(`/manager_profile${path}`);
      ...
      <Box sx={{ p: 3 }}>
        ...
        <List sx={{ px: 1 }}>
          ...
          >
            ...
            <ListItemText 
              primary="Mis Proyectos"
              primaryTypographyProps={{ 
                fontWeight: isActiveRoute('/campaigns') ? 600 : 500,
                fontSize: '0.9rem',
              }} 
            />
          </ListItemButton>
          ...
          <ListItemButton
            selected={isActiveRoute('/analytics')}
          ...
          >
            ...
            <ListItemText 
              primary="Análisis"
              primaryTypographyProps={{ 
                fontWeight: isActiveRoute('/analytics') ? 600 : 500,
                fontSize: '0.9rem',
              }} 
            />
          </ListItemButton>
