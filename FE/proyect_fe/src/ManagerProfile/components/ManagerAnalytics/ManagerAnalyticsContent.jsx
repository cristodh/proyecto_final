...
import MetricCard from "../ManagerMainPage/MetricCard/MetricCard";
...
export default function ManagerAnalyticsContent() {
          ...
          <Container maxWidth="lg" sx={{ py: 2 }}>
            ...
            <Grid container spacing={3} sx={{ mb: 4 }}>
              <Grid item xs={12} sm={6} md={3}>
                <MetricCard title="Conversión promedio" value="12.5%" hint="+2.3% vs mes anterior" icon={<TrendingUpIcon />} />
              </Grid>
              <Grid item xs={12} sm={6} md={3}>
                <MetricCard title="Donación promedio" value="₡15,750" hint="+5% vs mes anterior" icon={<AttachMoneyIcon />} />
              </Grid>
              <Grid item xs={12} sm={6} md={3}>
                <MetricCard title="Retención donadores" value="68%" hint="Meta: 70%" icon={<PeopleIcon />} />
              </Grid>
              <Grid item xs={12} sm={6} md={3}>
                <MetricCard title="ROI Campañas" value="340%" hint="Muy bueno" icon={<BarChartIcon />} />
              </Grid>
            </Grid>

            <Grid container spacing={3}>
              <Grid item xs={12} md={8}>
                <Paper elevation={0} sx={{ p: 3, borderRadius: 3, border: "1px solid rgba(255,140,0,0.1)", background: "linear-gradient(135deg, rgba(255, 140, 0, 0.02) 0%, rgba(255, 140, 0, 0.01) 100%)", height: 400 }}>
                  ...
                  <ResponsiveContainer width="100%" height={280}>
                    <LineChart data={monthlyData}>
                      ...
                      <Tooltip formatter={(value, name) => [`₡${value.toLocaleString()}`, name === 'recaudado' ? 'Recaudado' : 'Meta']} contentStyle={{ backgroundColor: 'white', border: '1px solid #3B82F6', borderRadius: '8px', boxShadow: '0 4px 6px rgba(59,130,246,0.2)' }} />
                      <Legend />
                      <Line type="monotone" dataKey="recaudado" stroke="#3B82F6" strokeWidth={3} dot={{ fill: '#3B82F6', strokeWidth: 2, r: 4 }} name="Recaudado" />
                      <Line type="monotone" dataKey="meta" stroke="#1E3A8A" strokeDasharray="5 5" strokeWidth={2} dot={{ fill: '#1E3A8A', strokeWidth: 2, r: 3 }} name="Meta" />
                    </LineChart>
                  </ResponsiveContainer>
                </Paper>
              </Grid>
                ...
                <Paper elevation={0} sx={{ p: 3, borderRadius: 3, border: "1px solid rgba(255,140,0,0.1)", background: "linear-gradient(135deg, rgba(255, 140, 0, 0.02) 0%, rgba(255, 140, 0, 0.01) 100%)", height: 400 }}>
                  ...
                  <ResponsiveContainer width="100%" height={280}>
                    <PieChart>
                      ...
                      <Tooltip formatter={(value) => [`${value}%`, 'Porcentaje']} contentStyle={{ backgroundColor: 'white', border: '1px solid #3B82F6', borderRadius: '8px' }} />
                    </PieChart>
                  </ResponsiveContainer>
                </Paper>
              </Grid>
              ...
              <Grid item xs={12}>
                <Paper elevation={0} sx={{ p: 3, borderRadius: 3, border: "1px solid rgba(255,140,0,0.1)", background: "linear-gradient(135deg, rgba(255, 140, 0, 0.02) 0%, rgba(255, 140, 0, 0.01) 100%)", height: 350 }}>
                  <Typography variant="h5" sx={{ fontWeight: 700, mb: 1 }}>
                  ...
                  <ResponsiveContainer width="100%" height={250}>
                    <BarChart data={donorGrowthData}>
                      ...
                      <Tooltip contentStyle={{ backgroundColor: 'white', border: '1px solid #3B82F6', borderRadius: '8px', boxShadow: '0 4px 6px rgba(59,130,246,0.2)' }} />
                      <Legend />
